...
function rowToInspection(row: InspectionRow): Inspection {
  return {
    ...
    inspectorSignaturePng: row.inspectorSignaturePng ?? undefined,
    homeownerSignaturePng: row.homeownerSignaturePng ?? undefined,
    homeownerSignedAt: row.homeownerSignedAt ?? undefined,
    businessLogoPng: row.businessLogoPng ?? undefined,
    ...
    photoRequirements: (row.photoRequirements as Inspection["photoRequirements"]) ?? undefined,
...
function inspectionToRow(i: Inspection) {
  return {
    ...
    inspectorEmail: i.inspectorEmail ?? null,
    ownerEmail: i.ownerEmail ?? null,
    ownerPhone: i.ownerPhone ?? null,
    inspectorSignaturePng: i.inspectorSignaturePng ?? null,
    homeownerSignaturePng: i.homeownerSignaturePng ?? null,
    homeownerSignedAt: i.homeownerSignedAt ?? null,
    businessLogoPng: i.businessLogoPng ?? null,
    property: i.property ?? null,
    fourPoint: i.fourPoint ?? null,
    windMit: i.windMit ?? null,
    photoRequirements: i.photoRequirements ?? null,
    status: i.status,
